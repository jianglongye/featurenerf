...
class SRNDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        # remove some bad images hard-codedly
        if "cars" in self.dataset_name:
            bad_ids = ["7edb40d76dff7455c2ff7551a4114669", "95ebb3fd80f885ad676f197a68a5168a"]
            self.intrins = [x for x in self.intrins if os.path.basename(os.path.dirname(x)) not in bad_ids]
