...
def parse_args(
    ...
    parser.add_argument("--datadir", "-D", type=str, default="data", help="Dataset directory")
    parser.add_argument("--synset", "-S", type=str, default="03001627", help="Synset ID for ShapeNet")
